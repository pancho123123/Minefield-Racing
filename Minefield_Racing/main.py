...
class Mine1(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.num = 0
        self.image1 = pygame.transform.scale(pygame.image.load("img/mine1.png").convert(),(30,30))
        self.image2 = pygame.image.load("img/fond.png").convert()
...
class Mine2(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.rect.y = random.randrange(10 , HEIGHT-50)
        self.num = 0
        self.image1 = pygame.transform.scale(pygame.image.load("img/mine22.png").convert(),(30,30))
        self.image2 = pygame.image.load("img/fond.png").convert()
